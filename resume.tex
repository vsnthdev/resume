...
\usepackage[
    pdftitle={Vasanth Srivatsa's CV},
    pdfauthor={Vasanth Srivatsa},
...
\begin{document}
    ...
    \section{Projects}
        \begin{twocolentry}{
            % \href{https://github.com/vsnthdev/SQLEd}{github.com/vsnthdev/SQLEd}
        }
        ...
        \begin{samepage}
            \begin{twocolentry}{
                ...
                \href{https://sessions.vsnth.dev}{\textbf{Debug Like a Detective: How to solve software bugs}}

                \vspace{0.10 cm}

                \mbox{\textbf{GIET University}} - \mbox{130 students} - \mbox{Full day}
                \vspace{0.10 cm}
            \end{twocolentry}
            \begin{twocolentry}{
                21st Feb 2024
                ...
                \vspace{0.30 cm}
                \href{https://sessions.vsnth.dev}{\textbf{Serving your app to millions (How big companies do it!)}}

                \vspace{0.10 cm}

                \mbox{\textbf{SRM University}} - \mbox{280 students} - \mbox{Full day}
                \vspace{0.10 cm}
            \end{twocolentry}
        \end{samepage}
\end{document}